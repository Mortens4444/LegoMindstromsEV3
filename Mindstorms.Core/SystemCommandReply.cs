...
{
    private readonly List<SystemCommand> CommandsWithLength = new() { SystemCommand.BeginFileUpload, SystemCommand.BeginGetFile, SystemCommand.ContinueGetFile, SystemCommand.ListFiles };
    private readonly List<SystemCommand> CommandsWithoutHandle = new() { SystemCommand.CloseFileHandle, SystemCommand.CreateDir, SystemCommand.DeleteFile, SystemCommand.ListOpenHandles, SystemCommand.BluetoothPin };
