namespace Mindstorms.Core.Enums
{
    ...
    {
		public static readonly FontType Tiny = new FontType(0x03, nameof(Tiny));
		public static readonly FontType Normal = new FontType(0x01, nameof(Normal));
		public static readonly FontType Big = new FontType(0x02, nameof(Big));
