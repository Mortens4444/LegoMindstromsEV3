namespace Mindstorms.Core.Enums
{
    ...
    {
        public static readonly Response Required = new Response(0x00, nameof(Required));
        public static readonly Response NotExpected = new Response(0x80, nameof(NotExpected));
